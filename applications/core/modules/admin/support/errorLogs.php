...
class _errorLogs extends \IPS\Dispatcher\Controller
{
	...
	public static function table( \IPS\Http\Url $url )
	{
		...
		$table->include = array( 'log_error_code', 'log_error', 'log_request_uri', 'log_member', 'log_date' );
		$table->mainColumn = 'log_error_code';
		$table->widths = array( 'log_error_code' => 10, 'log_request_uri' => 30, 'log_date' => 10, 'log_member' => 10 );
