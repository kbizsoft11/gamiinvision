...
class _Application extends \IPS\Application
{
	...
	public function acpMenu()
	{
		...
		/* Add Community Hive */
		$menu['communityhive']['settings'] = array(
			'tab'			=> 'community',
			'module_url'	=> 'applications',
			'controller'	=> 'enhancements',
			'do'			=> 'edit&id=core_Hive',
			'restriction'	=> 'enhancements_manage',
			'menu_checks'   => [ 'app' => 'ipshive' ] //intentionally bogus app
		);
