...
class _Member extends \IPS\Patterns\ActiveRecord
{
	...
	public function checkGroupPromotion()
	{
		...
		catch ( \OutOfRangeException $e )
		{
			try
			{
				$defaultGroup = \IPS\Member\Group::load( \IPS\Settings::i()->member_group );
				$this->member_group_id = \IPS\Settings::i()->member_group;
			}
			catch( \OutOfRangeException $e )
			{
				\IPS\core\AdminNotification::send( 'core', 'ConfigurationError', 'groupPromotionGroup', FALSE, NULL, TRUE );
			}
