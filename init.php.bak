...
{	
	...
	public static function defaultConstants()
	{
		...
		{
			$uniqueKey = mb_substr( md5( '12c53' . '$Rev: 3023$'), 10, 10 );
		}
		...
		return array(
			...
			// considered deprecated.
				...
				'CP_DIRECTORY'	=> '506938184591aplugin',	// The name of the directory where the AdminCP is
			...
			// to change them.
				...
				'CACHEBUST_KEY'		=> mb_substr( md5( '12c53' . '$Rev: 3023$'), 10, 10 ),
